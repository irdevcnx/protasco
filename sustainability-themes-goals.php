...
.cmx td{background:#88C298;}
    ...
    <section class="border-bottom-1px">
        <div class="container">
            <div class="heading-text heading-section text-left mb-0">
                <h3 class="mb-0"><span class="before-title-2"></span><img alt="" src="img/icon-bull.png" class="img-icon-15 mr-4">Sustainability Themes & Goals</h3>
            </div>
        </div>
    </section>
    ...
    <section class="">
     	<div class="container">
          <div class="row">
          	<div class="col-md-12">
          		<img src="img/ProtascoThemesandGoal 1.png" class="img-fluid">		
          	</div>
          </div>
        </div>
     </section>
